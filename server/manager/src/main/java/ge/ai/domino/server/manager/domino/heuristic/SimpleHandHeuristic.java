...
//        if (tableInfo.getMyTilesCount() != 0 && tableInfo.getHimTilesCount() != 0) {
//            heuristic = 6 * (getPossibleTurnCount(hand, true) / hand.getTableInfo().getMyTilesCount() - getPossibleTurnCount(hand, false) / hand.getTableInfo().getHimTilesCount());
//        }
        return heuristic;
    }
