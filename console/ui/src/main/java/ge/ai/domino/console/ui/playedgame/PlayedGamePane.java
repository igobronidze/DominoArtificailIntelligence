...
public class PlayedGamePane extends BorderPane {
    ...
    private ComboBox<PlayedGameResult> resultComboBox;
    ...
    private void initFilters() {
        ...
        resultComboBox.getItems().addAll(PlayedGameResult.values());
        resultComboBox.setConverter(new StringConverter<PlayedGameResult>() {
            @Override
            public String toString(PlayedGameResult object) {
                return Messages.get(object.name());
            }

            @Override
            public PlayedGameResult fromString(String string) {
                if (StringUtil.isEmpty(string)) {
                    return null;
                }
                return PlayedGameResult.valueOf(string);
            }
        });
    ...
    private void initTable() {
        ...
        TableColumn<PlayedGameProperty, Boolean> himPointColumn = new TableColumn<>(Messages.get("himPoint"));
        himPointColumn.setCellValueFactory(new PropertyValueFactory<>("himPoint"));
        himPointColumn.prefWidthProperty().bind(doubleBinding.divide(9));
        ...
        tableView.getColumns().addAll(idColumn, versionColumn, resultColumn, dateColumn, myPointColumn, himPointColumn,
